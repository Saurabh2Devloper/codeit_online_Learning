...
const Header = () => {
  ...
  return (
    <div>
      <div
        className={`navbar shadow-md ${toggle ? "bg-base-100" : "bg-hero-light-black text-white"
          }`}
      >
        <div className='navbar-start'>
          <div className='dropdown'>
            ...
            <ul
              tabIndex='0'
              className={`menu menu-compact dropdown-content mt-3 p-2 shadow rounded-box w-52 ${toggle ? "bg-base-100" : "bg-hero-light-black text-white"
                }`}
            >
              <li>
                <Link to='/'>Home</Link>
        ...
        <div className='navbar-end'>
          ...
          {user?.uid && (
            <>
              ...
              <div>
                <button className="btn btn-primary mx-4" >  <Link to='/cart'>
